<template>
  <div v-if="show" class="fixed  inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-50">
    <div class="bg-slate-300 rounded-lg p-8 w-96">
      ...
      <div class="transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg transition duration-300 ease-in-out bg-slate-50 hover:bg-slate-500 hover:text-white shadow-xl font-bold py-2 px-4 rounded">
